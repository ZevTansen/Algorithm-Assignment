...
int main(){
    cout << "Student Name: Tansen Nurmagomedov\n";
    cout << "Student ID: 123456\n\n";
  ...
  srand(time(0)); 
    ...
    for (int n : sizes) {
        ...
        auto durationIns = chrono::duration_cast<chrono::microseconds>(endIns - startIns);
        cout << "Insertion Sort Time: " << durationIns.count() << " microseconds" << endl;
        ...
        cout << "Merge Sort Time: " << durationMerge.count() << " microseconds" << endl;
